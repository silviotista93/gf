...
<head>
    ...
    <link href="/gf/images/apple-touch-icon.png" rel="apple-touch-icon">
    <link href="/gf/images/apple-touch-icon-72x72.png" rel="apple-touch-icon" sizes="72x72">
    <link href="/gf/images/apple-touch-icon-114x114.png" rel="apple-touch-icon" sizes="114x114">
    <link href="/gf/images/apple-touch-icon-144x144.png" rel="apple-touch-icon" sizes="144x144">
    ...
    <link id="menuzord-menu-skins" href="/gf/css/menuzord-skins/menuzord-boxed.css" rel="stylesheet"/>
    <!-- CSS | Main style file -->
    <link href="/gf/css/style-main.css" rel="stylesheet" type="text/css">

    <!-- CSS | Custom Margin Padding Collection -->
    <link href="/gf/css/custom-bootstrap-margin-padding.css" rel="stylesheet" type="text/css">
    <!-- CSS | Responsive media queries -->
    <link href="/gf/css/responsive.css" rel="stylesheet" type="text/css">
    <!-- CSS | Style css. This is the file where you can place your own custom css code. Just uncomment it and use it. -->
    <!-- <link href="css/style.css" rel="stylesheet" type="text/css"> -->

    <!-- CSS | Theme Color -->
    <link href="/gf/css/colors/theme-skin-color-set1.css" rel="stylesheet" type="text/css">

    <!-- external javascripts -->
    <script src="/gf/js/jquery-2.2.4.min.js"></script>
    <script src="/gf/js/jquery-ui.min.js"></script>
    <script src="/gf/js/bootstrap.min.js"></script>
    <!-- JS | jquery plugin collection for this theme -->
    <script src="/gf/js/jquery-plugin-collection.js"></script>
            ...
            <div class="container">
                ...
                {{--<div class="row">
                    <div class="col-md-12">
                        ...
                        <script src="/gf/js/google-map-init.js"></script>
...
<script src="/gf/js/custom.js"></script>
